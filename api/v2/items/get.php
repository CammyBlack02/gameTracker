 ...
 *
 * One item with its extra images, if it belongs to the authenticated user.
 * Thin wrapper over ItemsService::get — see list.php for why.
 */
...
try {
    v2_ok(ItemsService::get($pdo, $userId, (int)($_GET['id'] ?? 0)));
    ...
    v2_error('not_found', 'No such item', 404);
}
