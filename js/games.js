...
function getImageUrl(imagePath, size) {
    ...
    // base64 data URLs have no thumb variant, and the image proxy
    ...
    // which is auto-generated by upload.php at 512px on longest edge.
    // CoverFlow and game-detail keep using the full-res original.
    if (useThumb) {
